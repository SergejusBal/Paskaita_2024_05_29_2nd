...
public class Test_getBookCount {
    ...
    @Test
    public void getBookCount_TestNotEmptyList_returnsInt() {
        //Arrange
        ...
        int actualListSize = digitalLibrary.getBookCount();
        //Act
        assertEquals(expectedListSize, actualListSize);
    }

    @Test
    public void getBookCount_TestEmptyList_returnsInt() {
        //Arrange
